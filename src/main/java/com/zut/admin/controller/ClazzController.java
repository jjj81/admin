...
public class ClazzController {
	...
	String deleteByClazz(Model model, @PathVariable("clazzId") Integer clazzId) {
	...
	String deleteByFacultyId(Model model, @PathVariable("facultyId") Integer facultyId) {
	...
	String updateFacultyById(Model model, @PathVariable("facultyId") Integer facultyId, final Faculty faculty) {
